...
class CategoriaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create categorium" do
    assert_difference('Categorium.count') do
      post categoria_url, params: { categorium: { imagen: @categorium.imagen, nombre: @categorium.nombre } }
    end
  ...
  test "should update categorium" do
    patch categorium_url(@categorium), params: { categorium: { imagen: @categorium.imagen, nombre: @categorium.nombre } }
